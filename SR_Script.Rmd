...
# Analysis of the sex ratios in the F0
...
Here it is important to consider the influence of the breeding date on the total number of eggs released.
...
The cancerous females lay more eggs than the non-cancerous ones.
...
It is important to take into account the impact of the breeding date nested into the experimental trial.
...
There is no need to take into account random effects in this analysis.
...
There are no variations in the sex ratio that we can attribute to any effects we measured.
...
A sex ratio bias of around 10% could have been detected.
